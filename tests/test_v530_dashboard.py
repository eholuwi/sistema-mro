...
def test_dashboard_renderiza_com_dados(db, make_item):
    ...
    id_a = make_item(
        part_number="PN-DASH-1", nome="Item Dashboard 1", estoque=50, minimo=10, tipo="Spare Parts"
    )
    id_b = make_item(
        part_number="PN-DASH-2", nome="Item Dashboard 2", estoque=2, minimo=20, tipo="Consumivel"
    )
