...
def test_escopo_ignora_sem_id_ou_sem_sc():
    lic = [{"solicitacaoCompras": {"solicitante_Usuario": {"nome": "X"}}},  # sem id
           {"foo": "bar"}]                                                   # sem SC
...
_INV = {
    "PN-A": {"status_material": "🔴 COMPRAR", "unidade": "UN",
             "nome_item": "Item A", "previsao_ruptura_dias": 3},
    "PN-B": {"status_material": "🟢 OK", "unidade": "CX",
             "nome_item": "Item B", "previsao_ruptura_dias": PREVISAO_RUPTURA_SEM_RISCO + 10},
}
