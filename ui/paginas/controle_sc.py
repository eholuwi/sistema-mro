...
from services.db_functions import (
    GUARDA_CHUVA_ESTAGIOS, atualizar_guarda_chuva, atualizar_sc,
    carregar_planilha_livre, criar_guarda_chuva, criar_sc,
    filtrar_itens_por_busca, importar_relatorio_scs,
    importar_solicitacoes_protheus, itens_com_sc_aberta, listar_guarda_chuva,
    listar_inventario, listar_itens_sc, listar_monitor_sc,
    listar_recebimentos_sc, listar_scs, listar_valores,
    obter_cadastro_mro_para_cruzamento, obter_fornecedores_por_item,
    obter_guarda_chuva, registrar_recebimento_guarda_chuva,
    remover_guarda_chuva, saldo_total_por_material, salvar_planilha_livre,
    setor_dominante_por_item, sincronizar_monitor_sc,
)
from services.monitor_cruzamento import cruzar_scm_sc7, preparar_df
from services.monitor_scm import (
    COLUNAS_SCS_NAO_ATENDIDAS, cotacoes_no_escopo, montar_scs_nao_atendidas,
)
from services.planejamento import (
    agrupar_por_tipo_material, buscar_sc_id_por_numero,
    gerar_sugestoes_reposicao, registrar_desfecho_sugestao, resumir_grupo_sc,
